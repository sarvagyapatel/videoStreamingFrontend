        ...
        <div className="-m-8 flex flex-wrap items-center justify-between">
          ...
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              <li className="p-5">
                <a className="font-medium text-gray-300 hover:text-gray-700" href="#">
                  Privacy Policy
                </a>
              </li>
              <li className="p-5">
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <a href="#">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-blue-900 hover:border-gray-400">
                    <svg
                      width="8"
                      height="14"
                      viewBox="0 0 8 14"
              ...
              <div className="w-auto p-1.5">
                <a href="#">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-cyan-500 hover:border-gray-400">
                    <svg
                      width="14"
                      height="11"
                      viewBox="0 0 14 11"
              ...
              <div className="w-auto p-1.5">
                <a href="#">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-fuchsia-700 hover:border-gray-400">
                    <svg
                      width="16"
                      height="15"
                      viewBox="0 0 16 15"
